 function Login(){
    ...
    else if (username=="filosofia" && password=="vinigay") {window.location="/paginas/filosofia.html"; done=1; }
    //digaoviadasso??//
    ...
    else if (username=="filosofia" && password=="josevit") {window.location="/paginas/filosofia.html"; done=1; }
    //jose//
    ...
    else if (username=="fisica" && password=="nugs") {window.location="fisica.html"; done=1; }
    else if (username=="biologia" && password=="nugs") {window.location="biologia.html"; done=1; }
    else if (username=="quimica" && password=="nugs") {window.location="quimica.html"; done=1; }
    //nugoli//
    ...
    //ticao//
    else if (username=="matematica" && password=="nickiiliuk") {window.location="matematica.html"; done=1; }
    //nick//
